...
Toy.create!(brand: 'Baby Einstein', category: 'Baby Toys', condition: 'Like New', description: Faker::Lorem.sentence, name:'Rattle', age_group: '0-1 yr', profile_image: '/assets/toy2.png')
...
Toy.create!(brand: 'Disney', category: 'Dolls', condition: 'Fair Condition', description: Faker::Lorem.sentence, name:'Elmo', age_group: '1-2yrs', profile_image: '')
...
Toy.create!(brand: 'EeBoo', category: 'Baby Toys', condition: 'Like New', description: Faker::Lorem.sentence, name:'Rattle', age_group: '0-1yr', profile_image: '')
...
Toy.create!(brand: 'Lamaze', category: 'Baby Toys', condition: 'Good Condition', description: Faker::Lorem.sentence, name:'CCC', age_group: '4-8yrs', profile_image: '')
...
Toy.create!(brand: 'Manhattan Toys', category: 'Baby Toys', condition: 'Fair Condition', description: Faker::Lorem.sentence, name:'HHH', age_group: '0-1yr', profile_image: '')
...
Toy.create!(brand: 'Marvel', category: 'Dolls', condition: 'Good Condition', description: Faker::Lorem.sentence, name:'KKK', age_group: '4-8yrs', profile_image: '')
...
Toy.create!(brand: 'Whisper Phone', category: 'Baby Toys', condition: 'Like New', description: Faker::Lorem.sentence, name:'NNN', age_group: '0-1yr', profile_image: '')
...
Toy.create!(brand: 'Baby Einstein', category: 'Baby Toys', condition: 'Like New', description: Faker::Lorem.sentence, name:'ZZZ', age_group: '0-1yr', profile_image: '')
